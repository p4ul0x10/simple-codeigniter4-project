...
<section id="about-project">
    ...
    <p>The project you are looking at is being generated dynamically by CodeIgniter and edited with + resources.</p>

    <p>It is a simple initial project following the documentation with a few more features added by me.</p>

    <pre><code>New section with: Menu added</code></pre>

    <p>The corresponding controller for this page can be found at:</p>

    <pre><code>New links with: archors for new pages (for crud system)</code></pre>
...
<div class="further">
    ...
    <section>
        ...
        <p>Used to create structure (front-end) created through the initial model system according to the CodeIgniter documentation</p>
        ...
        <p>Used to manipulate HTML elements (form's), across some pages of the project.</p>
        ...
        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'><line x1='176' y1='48' x2='336' y2='48' class="svg-stroke" /><line x1='118' y1='304' x2='394' y2='304' class="svg-stroke" /><path d='M208,48v93.48a64.09,64.09,0,0,1-9.88,34.18L73.21,373.49C48.4,412.78,76.63,464,123.08,464H388.92c46.45,0,74.68-51.22,49.87-90.51L313.87,175.66A64.09,64.09,0,0,1,304,141.48V48' class="svg-stroke" /></svg>
            PHP + Codeigniter features 
        </h2>

        <p>Used to create parts of the project, such as controllers, model and views.</p>

    </section>
    <style>
        section nav ul { list-style-type: none; padding: 0px; }
        section nav ul li { display: inline-block; }
        section nav ul li a { margin: 0px 4px; }
        section nav ul li a:hover { color: rgba(62, 62, 62, 1); }
    ...
    <section>
        ...
        <nav id="edited-project">
            <ul>
                <li><a href="<?= esc($item1); ?>"><?= esc($item1); ?></a></li>
                <li><a href="<?= esc($item2); ?>"><?= esc($item2); ?></a></li>
                <li><a href="<?= esc($item3); ?>"><?= esc($item3); ?></a></li>
                <li><a href="<?= esc($item4); ?>"><?= esc($item4); ?></a></li>
            </ul>
        </nav>
        <h4>Crud system created</h4>
    </section>
    <section>
        <div id="some-works" class="trace-content">------------------------------------------</div>
        <h1>+ Some works</h1>
        <p><a href="https://github.com/p4ul0x10" target="_blank" alt="p4ul0x10 github projects">Github</a> - <a href="https://www.freelancer.com/u/paulohonrio" target="_blank" alt="paulohonrio freelancer projects">Freelancer</a></p>
    </section>
</div>
